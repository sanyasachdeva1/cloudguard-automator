...
from cloudguard_automator.report import render_html, render_json, render_markdown, write_report
...
def build_parser() -> argparse.ArgumentParser:
    ...
    scan.add_argument("--format", choices=["json", "markdown", "html"], default="markdown", help="Report format.")
...
def main() -> None:
    ...
    if args.command == "scan":
        ...
        content = _render_scan(findings, args.format)
...
def _render_scan(findings, output_format: str) -> str:
